...
include('session.php');
	...
	$result = mysqli_query($con,"SELECT * FROM taker where last='$last' and first='$first' and bday='$bday'"); 
	 ...
	 or die(mysqli_error($con)); 
			...
			mysqli_query($con,"INSERT INTO taker(last,first,gender,bday,phone,referrer_id,referrer_contact,status,height,orig_weight,coach_id) 
				VALUES('$last','$first','$gender','$bday','$phone','$referrer','$rcontact','Active','$height','$weight','$coach')")or die(mysqli_error($con));  
