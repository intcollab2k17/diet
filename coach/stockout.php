...
<?php
        $id=$_SESSION['id'];
        $query=mysqli_query($con,"select * from stockout natural join product natural join taker where admin_id='$id' order by stockout_date desc")or die(mysqli_error($con));
            $i=1;
