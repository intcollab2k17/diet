...
<?php
        $coach=$_SESSION['id'];
        $query=mysqli_query($con,"select * from taker where status='Active' and coach_id='$coach'")or die(mysqli_error($con));
...
<?php
    $result = mysqli_query($con,"SELECT gender FROM `monitoring` natural join taker where monitor_status!='Finished' and gender='male' and coach_id='$coach' group by gender");
...
<?php
    $result = mysqli_query($con,"SELECT gender FROM `monitoring` natural join taker where monitor_status!='Finished' and gender='female' and coach_id='$coach' group by gender");
...
<?php
        $a=1;
        $query=mysqli_query($con,"select * from taker where coach_id='$coach' and status='Active' order by last,first")or die(mysqli_error($con));
