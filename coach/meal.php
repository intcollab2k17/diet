...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Daily Meal</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" action="meal_edit.php">
                                                <input type="hidden" name="id" value="<?php echo $row['meal_id'];?>">
                                                <div class="form-group">
                                                    <label>Time</label>
                                                    <input class="form-control" type="text" name="time" value="<?php echo $row['meal_time'];?>" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Meal Description</label>
                                                    <input class="form-control" type="text" name="meal" value="<?php echo $row['meal'];?>" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Calories</label>
                                                    <input class="form-control" type="text" name="cal" value="<?php echo $row['calories'];?>" required>
                                                </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" action="meal_add.php">
                                                ...
                                                <div class="form-group">
                                                    <label>Meal Description</label>
                                                    <input class="form-control" type="text" name="meal" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Calories</label>
                                                    <input class="form-control" type="text" name="cal" required>
                                                </div>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
