        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                   ...
                   <h3 class="page-header" style="text-align: center;">Takers' List</h3>
                </div>
        ...
        $query=mysqli_query($con,"select * from taker order by last,first")or die(mysqli_error($con));
          ...
          while ($row=mysqli_fetch_array($query)){
            $id=$row['id'];
                 ...
                 $query1=mysqli_query($con,"select * from monitoring natural join program where id='$id' and monitor_status!='Finished' order by monitor_id desc LIMIT 0,1")or die(mysqli_error($con));
